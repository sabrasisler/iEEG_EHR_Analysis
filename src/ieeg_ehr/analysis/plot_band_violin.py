...
ieeg_ehr/preprocessing/bipolar_bands.py's aggregate_to_bands convention (avoids
...
Run on a dev/interactive Slurm shell (never the login node):
    ...
    python -m ieeg_ehr.analysis.plot_band_violin
"""
...
def main():
    ...
    common.write_run_provenance(
        run_dir, 'ieeg_ehr/analysis/plot_band_violin.py', args, cache_paths,
        subjects=subjects,
