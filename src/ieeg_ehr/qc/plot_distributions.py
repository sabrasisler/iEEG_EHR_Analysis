...
Usage:
  python -m ieeg_ehr.qc.plot_distributions --level-root /path/to/qc/raw_voltage [--output-dir DIR]
"""
...
def _metric_csvs(level_root, artifact_type):
    ...
    # one-per-subject-per-session like raw_voltage's -- see docs/qc_context.md.
