...
Usage:
  python -m ieeg_ehr.qc.build_exclusions --level-root <path> --artifact-type gross_artifact --label std4 --std-thresh 4
  python -m ieeg_ehr.qc.build_exclusions --level-root <path> --artifact-type flatline --std-thresh 3   # -> logz3
  python -m ieeg_ehr.qc.build_exclusions --level-root <path> --artifact-type all --label default
