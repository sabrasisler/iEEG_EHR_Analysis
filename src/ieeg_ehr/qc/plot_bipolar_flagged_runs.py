...
Usage:
  python -m ieeg_ehr.qc.plot_bipolar_flagged_runs --targets 085:LAMY1-LAMY2 --labels std4
  python -m ieeg_ehr.qc.plot_bipolar_flagged_runs --targets 085:LAMY1-LAMY2 --labels std3,std4,std5
"""
