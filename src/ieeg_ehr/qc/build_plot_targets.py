...
Usage:
  python -m ieeg_ehr.qc.build_plot_targets --output-dir /path/to/qc_variance_padded30 \
...
from ieeg_ehr.qc.plot_flagged_runs import top_runs_for_channel, find_random_any_examples
