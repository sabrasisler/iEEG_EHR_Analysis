...
Usage:
  python -m ieeg_ehr.qc.plot_flagged_runs --targets 093:LOF10,093:RINS7 --n-runs 2
  python -m ieeg_ehr.qc.plot_flagged_runs --find-flatline-examples 2
  python -m ieeg_ehr.qc.plot_flagged_runs \
