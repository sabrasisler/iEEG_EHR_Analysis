...
Usage:
  python -m ieeg_ehr.qc.build_run_start_times --subjects 093,217
  python -m ieeg_ehr.qc.build_run_start_times --subjects 093,217 --out /path/to/run_start_times.csv
"""
