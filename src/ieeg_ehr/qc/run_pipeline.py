...
Usage:
  python -m ieeg_ehr.qc.run_pipeline --n-subjects 3
  python -m ieeg_ehr.qc.run_pipeline --subjects 217,222
  python -m ieeg_ehr.qc.run_pipeline --subjects 217,222 --output-dir /path/to/alt/root
"""
